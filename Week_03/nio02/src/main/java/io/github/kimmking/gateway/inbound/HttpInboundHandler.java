...
public class HttpInboundHandler extends ChannelInboundHandlerAdapter {
    ...
    public HttpInboundHandler(String proxyServer) {
        ...
        //nettyHttpClient  = new NettyHttpClient(this.proxyServer);
    }
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        try {
            ...
            String endpoint = router.route(fullRequest.uri());
            fullRequest.setUri(endpoint);
            //String[] ser = proxyServer.split(":");
            //nettyHttpClient.connect("127.0.0.1",Integer.parseInt(ser[2]));
